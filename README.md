...
> Antes y después de cambios masivos, puedes validar todos los JSON con `python3 tools/check_assets_json.py` o revisar campos básicos de plantas con `python3 tools/check_assets_json.py --top-level-only --validate-plants`.
