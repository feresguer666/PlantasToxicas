...
interface PlantDao {
    ...
    @Query("SELECT * FROM plants WHERE commonName LIKE :query OR commonNames LIKE :query OR scientificName LIKE :query OR category LIKE :query")
    ...
    @Query("SELECT * FROM plants ORDER BY scientificName ASC")
