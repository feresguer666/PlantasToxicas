...
@Database(
    entities = [PlantEntity::class, CompoundEntity::class, MushroomEntity::class, ToxicCalendarEvent::class, PoisonousFamilyGenusEntity::class],
    version = 11,
    exportSchema = true
)
abstract class PlantDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        /**
         * v9 → v10: crea la tabla editable de Familias venenosas.
            ...
            override fun migrate(db: SupportSQLiteDatabase) {
                db.execSQL(
                    ...
                    CREATE TABLE IF NOT EXISTS `poisonous_family_genera` (
                        ...
                        `notes` TEXT NOT NULL,
                        `catalogType` TEXT NOT NULL DEFAULT 'all',
                ...
                db.execSQL("CREATE INDEX IF NOT EXISTS `index_poisonous_family_genera_catalogType` ON `poisonous_family_genera` (`catalogType`)")
            }
        }

        /**
         * v10 → v11: añade catalogType para separar:
         * - familias con todos sus géneros venenosos
         * - familias con algunos géneros venenosos
         */
        val MIGRATION_10_11 = object : Migration(10, 11) {
            override fun migrate(db: SupportSQLiteDatabase) {
                db.execSQL("ALTER TABLE poisonous_family_genera ADD COLUMN catalogType TEXT NOT NULL DEFAULT 'all'")
                db.execSQL("CREATE INDEX IF NOT EXISTS `index_poisonous_family_genera_catalogType` ON `poisonous_family_genera` (`catalogType`)")
            }
        }
