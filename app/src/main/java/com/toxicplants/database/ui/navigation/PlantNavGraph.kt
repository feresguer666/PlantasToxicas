    ...
    NavHost(navController = navController, startDestination = Screen.Home.route) {
        ...
        composable(Screen.CameraIdentify.route) {
            CameraIdentifyScreen(
                viewModel = viewModel,
                onPlantClick = { plant: PlantEntity -> viewModel.selectPlant(plant); navController.navigate(Screen.PlantDetail.createRoute(plant.id)) },
                onNavigateToPlantNetResult = { name, scientificName -> navController.navigate(Screen.PlantNetResult.createRoute(name, scientificName)) },
