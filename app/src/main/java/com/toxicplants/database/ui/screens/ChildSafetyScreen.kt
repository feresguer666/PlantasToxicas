            ...
            TopAppBar(
                title = {
                    Column {
                        ...
                        Text(
                            "${filteredPlants.size} plantas · Niños < 12 años",
                            fontSize = 11.sp,
            ...
            Card(
                ...
                Row(
                    ...
                    Column {
                        ...
                        Text(
                            "En caso de ingesta llama al 112",
                            fontSize = 11.sp,
                    ...
                    Card(
                        ...
                        Row(
                            ...
                            Column(modifier = Modifier.weight(1f)) {
                                ...
                                Spacer(Modifier.height(4.dp))
                                Text(
                                    "🚑 ${plant.firstAid.take(80)}${if (plant.firstAid.length > 80) "…" else ""}",
                                    fontSize = 11.sp,
                            ...
                            Surface(
                                color = toxColor.copy(alpha = 0.24f),
                            ...
                            IconButton(
                                onClick = {
                                    PlantExtraDataSource.setToxicChildren(
                                        context,
                                        plant.scientificName,
                                        false
                                    )
