    ...
    Card(
        ...
        Row(
            ...
            Column(modifier = Modifier.weight(1f)) {
                ...
                if (compound.mechanism.isNotBlank()) {
                    Row(verticalAlignment = Alignment.CenterVertically, modifier = Modifier.padding(top = 4.dp)) {
                        Icon(Icons.Filled.Psychology, contentDescription = null, tint = Color(0xFF6A1B9A), modifier = Modifier.size(14.dp))
                        Spacer(Modifier.width(4.dp))
                        Text("Mecanismo detallado", fontSize = 11.sp, color = Color(0xFF6A1B9A), fontWeight = FontWeight.Bold)
                    }
                }
            }
