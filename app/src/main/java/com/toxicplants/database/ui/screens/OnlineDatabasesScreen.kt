...
val onlineDatabases = listOf(
    ...
    PoisonDatabase("FDA Poisonous Plant Database",   "Banco de datos de plantas venenosas de la FDA.",                           "https://www.fda.gov/food/science-research-food/fda-poisonous-plant-database",                              "🌿"),
    ...
    PoisonDatabase("NC State Plant Toolbox",         "Base de datos detallada sobre plantas con enfoque en toxicidad y seguridad.", "https://plants.ces.ncsu.edu/",                                                                         "🏫"),
    PoisonDatabase("Cornell Poisonous Plants",       "Referencia de Cornell sobre plantas tóxicas para humanos y animales.",     "https://cals.cornell.edu/weed-science/poisonous-plants",                                                   "🐄"),
    ...
    PoisonDatabase("iNaturalist",                    "Red social de ciencia ciudadana para observar e identificar flora y fauna.", "https://www.inaturalist.org/",                                                                         "🐞"),
    PoisonDatabase("Plants For A Future (PFAF)",     "Base de datos sobre plantas útiles, comestibles y tóxicas.",               "https://pfaf.org/",                                                                                        "🌿"),
...
val extraResources = listOf(
    ...
    PoisonDatabase("Flora Ibérica",                             "Información taxonómica exhaustiva de las plantas de la Península Ibérica y Baleares.", "http://www.floraiberica.es/",                                                                             "📜"),
    PoisonDatabase("Plants of the World Online (Kew)",          "Catálogo global de plantas mantenido por el Royal Botanic Gardens, Kew.",              "https://powo.science.kew.org/",                                                                                   "🌍"),
    PoisonDatabase("The Poison Garden",                         "Web educativa dedicada a las plantas más peligrosas del mundo.",                       "https://www.thepoisongarden.info/",                                                                               "🥀"),
...
/**
 * Abre una URL en el navegador del sistema de forma robusta:
 * - Añade FLAG_ACTIVITY_NEW_TASK (necesario en algunos contextos sin Activity).
 * - Captura ActivityNotFoundException si no hay navegador y muestra Toast.
 * - Requiere el bloque <queries> en AndroidManifest.xml para Android 11+.
 */
private fun openUrlSafely(context: android.content.Context, url: String) {
    try {
        ...
        android.widget.Toast.makeText(
            context,
            "No hay navegador instalado para abrir el enlace",
            android.widget.Toast.LENGTH_LONG
        ).show()
    } catch (e: Exception) {
        android.widget.Toast.makeText(
            context,
            "No se pudo abrir el enlace: ${e.message}",
            android.widget.Toast.LENGTH_LONG
        ).show()
    }
}
