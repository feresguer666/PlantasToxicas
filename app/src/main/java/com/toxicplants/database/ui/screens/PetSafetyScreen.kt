            ...
            TopAppBar(
                title = {
                    Column {
                        ...
                        Text(
                            "${filteredPlants.size} plantas encontradas",
                            fontSize = 11.sp,
        ...
        Column(modifier = Modifier
            ...
            Card(
                ...
                Row(
                    ...
                    Text(
                        "Lleva una muestra o foto de la planta.",
                        fontSize = 12.sp,
                        ...
                        Row(
                            ...
                            Column(modifier = Modifier.weight(1f)) {
                                ...
                                Row(horizontalArrangement = Arrangement.spacedBy(4.dp)) {
                                    if (extra?.toxicDogs == true) Surface(
                                    ...
                                    if (extra?.toxicCats == true) Surface(
                                        color = Color(0xFF5C6BC0).copy(
                                            alpha = 0.15f
                                        ), shape = RoundedCornerShape(4.dp)
                                    ) {
                                        Text(
                            ...
                            IconButton(
                                onClick = {
                                    when (selectedTab) {
                                        0 -> PlantExtraDataSource.setToxicDogs(
                                            context,
                                            plant.scientificName,
                                            false
                                        )

                                        1 -> PlantExtraDataSource.setToxicCats(
                                            context,
                                            plant.scientificName,
                                            false
                                        )
                                        ...
                                        2 -> {
                                            PlantExtraDataSource.setToxicDogs(
                                                context,
                                                plant.scientificName,
                                                false
                                            ); PlantExtraDataSource.setToxicCats(
                                                context,
                                                plant.scientificName,
                                                false
                                            )
